...
bool isLowerPriority(const shabalin::InfixType & lhs, const shabalin::InfixType & rhs)
{
...
shabalin::Queue< shabalin::PostfixType > shabalin::convertToPostfix(Queue< InfixType > & queue_source)
{
