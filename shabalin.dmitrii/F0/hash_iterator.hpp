...
template< class Key, class Value, class Hash, class Equal >
shabalin::HashIterator< Key, Value, Hash, Equal >::HashIterator():
  table_(nullptr),
  ind_(0),
  node_(nullptr)
{}
...
template< class Key, class Value, class Hash, class Equal >
shabalin::HashIterator< Key, Value, Hash, Equal >::HashIterator(HashT *t, size_t i, HashNode< Key, Value > *n):
  table_(t),
  ind_(i),
  node_(n)
{}
...
template< class Key, class Value, class Hash, class Equal >
shabalin::HashIterator< Key, Value, Hash, Equal > &shabalin::HashIterator< Key, Value, Hash, Equal >::operator++() noexcept
{
  if (node_)
  {
    node_ = node_->next_;
...
template< class Key, class Value, class Hash, class Equal >
void shabalin::HashIterator< Key, Value, Hash, Equal >::goNext() noexcept
{
  ++ind_;
...
template< class Key, class Value, class Hash, class Equal >
shabalin::HashIterator< Key, Value, Hash, Equal > shabalin::HashIterator< Key, Value, Hash, Equal >::operator++(int) noexcept
{
...
template< class Key, class Value, class Hash, class Equal >
bool shabalin::HashIterator< Key, Value, Hash, Equal >::operator==(Iter &rhs) const noexcept
{
...
template< class Key, class Value, class Hash, class Equal >
std::pair< Key, Value > &shabalin::HashIterator< Key, Value, Hash, Equal >::operator*() noexcept
{
  return node_->data_;
}
