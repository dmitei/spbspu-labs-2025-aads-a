...
void shabalin::printGraphsNames(std::ostream& out, const MapOfGraphs& graphs)
{
  if (graphs.empty())
  {
    out << "\n";
...
void shabalin::printVertexesNames(std::ostream& out, std::istream& in, const MapOfGraphs& graphs)
{
...
void shabalin::printOutbounds(std::ostream& out, std::istream& in, const MapOfGraphs& graphs)
{
  std::string graphName;
  std::string vertex;
  in >> graphName >> vertex;
...
void shabalin::printInbounds(std::ostream& out, std::istream& in, const MapOfGraphs& graphs)
{
  std::string graphName;
  std::string vertex;
  in >> graphName >> vertex;
...
void shabalin::bind(std::istream& in, MapOfGraphs& graphs)
{
  std::string graphName;
  std::string from;
  std::string to;
...
void shabalin::cut(std::istream& in, MapOfGraphs& graphs)
{
  std::string graphName;
  std::string from;
  std::string to;
...
void shabalin::create(std::istream& in, MapOfGraphs& graphs)
{
  std::string graphName;
  in >> graphName;
...
void shabalin::merge(std::istream& in, MapOfGraphs& graphs)
{
  std::string newName;
  std::string name1;
  std::string name2;
...
void shabalin::extract(std::istream& in, MapOfGraphs& graphs)
{
  std::string newName;
  std::string oldName;
  size_t vertexCount = 0;
